        ...
        <section id='portfolio-link'>
          <div id='portfolio' className='flex-row'>
            ...
            <div className='columns overlaythree'>
              ...
              <a href={portfolioProjects[0].live} title='View Site' className='pseudover v2' target="_blank" rel="noopener noreferrer">
            ...
            <div className='columns overlaythree'>
              ...
              <a href={portfolioProjects[1].live} title='View Site' className='pseudover v2' target="_blank" rel="noopener noreferrer">
            ...
            <div className='columns overlaythree'>
              ...
              <a href={portfolioProjects[2].live} title='View Site' className='pseudover v2' target="_blank" rel="noopener noreferrer">
